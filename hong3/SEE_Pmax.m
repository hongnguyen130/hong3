...
dxE = 33;      %# toa Ä‘o ngang may nghe len (m)
...
% 
% P0=epsilon;
Pmax_set=[0 5 10 15 20];%dBm
SEE_avg=zeros(length(Pmax_set),1);
%epsP=P0;
sig1 = sigma1 ;     
sig2 = sigma2 ;
sigE = sigmaE;   
...
%Luu lich su ve hoi tu 2 tang AO vÃ  Dinkelbach
...
%         end
    ...
    SEE_hist(itSample)=SEE_D;
end
SEE_avg(i)=mean(SEE_hist);
end


figure;
plot(Pmax_set, SEE_avg, '-o', 'LineWidth', 1.5);
grid on;
...
save('SEE_Pmax_Ns_50result_dinkelbach.mat','SEE_avg','Ns','Pmax_set')
