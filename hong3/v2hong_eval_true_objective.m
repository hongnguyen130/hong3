...
% Eve decoding x1
SINR_E_x1_IRS    = ( S1+ NEa)    / ((anpha2 + anphaAN) * S1    + NEa);
SINR_E_x1_nonIRS = ( S1bar+ NEa) / ((anpha2 + anphaAN) * S1bar + NEa);

% Eve decoding x2
SINR_E_x2_IRS    = (S1+ NEa)    / ((anpha1 + anphaAN) * S1    + NEa);
SINR_E_x2_nonIRS = ( S1bar+ NEa) / ((anpha1 + anphaAN) * S1bar + NEa);
