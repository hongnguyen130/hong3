...
dxE = 25;      %# toa Ä‘o ngang may nghe len (m)
...
noise_awgn_dBm = -65;
sigma_awgn = 10^(noise_awgn_dBm / 10) * 10^(-3);  %# cong suat nhieu (W)
sigma1=sigma_awgn;
sigma2=sigma_awgn;
sigmaE=sigma_awgn;
