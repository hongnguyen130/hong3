...
data35 = load('pareto_mean_P35.mat');
...
% --- Pmax = 35 ---
plot(data35.RE, data35.SEE_mean, 'r-', 'LineWidth', 2);
fill([data35.RE; flipud(data35.RE)], ...
     [data35.SEE_mean - data35.SEE_std; flipud(data35.SEE_mean + data35.SEE_std)], ...
     'r', 'FaceAlpha', 0.15, 'EdgeColor','none');

% --- Pmax = 40 ---
plot(data40.RE, data40.SEE_mean, 'g-', 'LineWidth', 2);
...
legend(...
    ...
    'Pmax=35 (NSGA-II)','', ...
    'Pmax=40 (NSGA-II)','', ...
    'AO Pmax=30','AO Pmax=35','AO Pmax=40', ...
    'Location','best');
